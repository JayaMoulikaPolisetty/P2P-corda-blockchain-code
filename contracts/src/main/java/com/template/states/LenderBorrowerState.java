...
public class LenderBorrowerState implements ContractState {
    ...
    public LenderBorrowerState(String user_credit_type, double interest_rate, double amount, int durationInMonths, String loan_category, String writeup, LocalDateTime contract_initiation_time, double interest, double platform_fee, UniqueIdentifier loanNumber, UniqueIdentifier borrower_id, UniqueIdentifier lender_id, LocalDateTime contract_enforcement_time, Party myParty, Party otherParty) {
